...
export default function () {
  ...
  gsap.to("#_bgw-n", { "stroke-dashoffset": 0, duration: 25 * waterSpeed, delay: 0.5, ease: "none" });

  gsap.to("#_w-a", { "stroke-dashoffset": 0, duration: 10 * waterSpeed, delay: 0.5, ease: "none" });
  gsap.to("#_bgw-a", { "stroke-dashoffset": 0, duration: 10 * waterSpeed, delay: 0.5, ease: "none" });

  gsap.to("#_w-k", { "stroke-dashoffset": 0, duration: 10 * waterSpeed, delay: 0.5, ease: "none" });
  gsap.to("#_bgw-k", { "stroke-dashoffset": 0, duration: 10 * waterSpeed, delay: 0.5, ease: "none" });

  gsap.to("#_w-m", { "stroke-dashoffset": 0, duration: 25 * waterSpeed, delay: 0.5, ease: "none" });
  gsap.to("#_bgw-m", { "stroke-dashoffset": 0, duration: 25 * waterSpeed, delay: 0.5, ease: "none" });
